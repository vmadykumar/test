        ...
        stages {
                ...
                stage('Release'){
                        ...
                        steps {
                                ...
                                deploy adapters: [tomcat7(credentialsId: '62338c49-0648-4646-8730-f3015bfd0c15', path: '', url: 'http://172.30.11.187:8081')], contextPath: '/HappyTrip', onFailure: false, war: 'Code/target/*.war'
                        }
                }
                stage('Notification') {
                        steps {
